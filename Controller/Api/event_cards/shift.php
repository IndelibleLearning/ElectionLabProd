<?php
    ...
    $remove_state_abbrev = $data["remove_state_abbrev"];
    $add_state_abbrev = $data["add_state_abbrev"];
    ...
    // validate remove state
    $rem_state_response = $state_model->validate_state_by_abbrev($remove_state_abbrev);
    if ($rem_state_response->get_has_errors())
    {
        echo $rem_state_response->get_json_error();
        die();
    }
    $remove_state = $rem_state_response->get_data();
    
    // validate add state
    $add_state_response = $state_model->validate_state_by_abbrev($add_state_abbrev);
    if ($add_state_response->get_has_errors())
    {
        echo $add_state_response->get_json_error();
        die();
    }
    $add_state = $add_state_response->get_data();
